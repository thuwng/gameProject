...
const string WORD_LIST[] = {
    ...
    "cow", "cup", "curtain", "cushion", "couple", "cooking",
    "dog", "door", "drain", "drawer", "dress", "drop", "ear", "egg", "engine", "eye",
    "face", "farm", "feather", "finger", "fish", "flag", "floor", "fly",
    "garden", "girl", "glove", "goat", "gun", "global", "graduate",
    "hair", "hammer", "hand", "hat", "head", "heart", "hook", "horn", "horse",
    "hospital", "house", "helicopter", "hockey", "hear", "hope",
    "island", "icecream", "innovation", "jewel", "jungle",
    "key", "knee", "knife", "knot", "king", "keep", "kid",
    "leaf", "leg", "library", "line", "lip", "lock", "lemon",
    ...
    "store", "street", "sun", "soup", "singer", "standle"
    "table", "tail", "thread", "throat", "thumb", "ticket", "toe", "tongue", "tooth",
    "town", "train", "tray", "tree", "trousers", "treat",
    "umbrella", "uncle", "understand", "unique", "university",
